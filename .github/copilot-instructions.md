...
PLEASE USE THE CORATES MCP tools to explore local documentation sources. Use this MCP for all Better-Auth, Drizzle, Icons, and Zag documentation. For comprehensive development guides, see the docs site (`packages/docs/`) - run `pnpm docs` to view. For linting, prefer using the MCP.
