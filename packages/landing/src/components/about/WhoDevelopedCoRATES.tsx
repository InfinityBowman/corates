  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-20">
      <div className="mb-12 text-center">
        <h2 className="mb-4 text-2xl font-bold text-gray-900 md:text-3xl">Who Developed CoRATES?</h2>
        <p className="mx-auto max-w-3xl leading-relaxed text-gray-600">
          ...
          practical, user-centered features with thoughtful design to enhance both the rigor and the
          efficiency of the evidence appraisal process.
        </p>
      </div>
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-shadow duration-200 hover:shadow-md">
          ...
          <div className="space-y-4 text-sm leading-relaxed text-gray-600">
            ...
            <p>
              ...
              regularly teaches systematic review methods, supervises doctoral students conducting
              evidence syntheses, and supports research teams in developing high-quality,
              methodologically sound reviews. Her firsthand experience with the practical challenges
              of managing the study appraisal process shaped the vision for CoRATES and directly
              informed its emphasis on usability and methodological rigor.
            </p>
            <p>
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-shadow duration-200 hover:shadow-md">
          <div className="mb-6 flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-sm font-medium text-blue-600">Software Engineer & Data Scientist</p>
          </div>
          <div className="space-y-4 text-sm leading-relaxed text-gray-600">
            <p>
              ...
              interface design, and data visualization, he enjoys building tools that solve
              practical problems for real users.
            </p>
            <p>
              His early work visualizing risk-of-bias data for an overview of reviews sparked his
              interest in research synthesis processes, and he brings a strong commitment to
              creating thoughtful, high-quality user experiences.
            </p>
            <p>
              As the technical lead for CoRATES, Jacob built the platform from the ground up,
              translating methodological requirements into a modern, collaborative system.
            </p>
            <p>
              His software engineering expertise and attention to research workflows are central to
              the platform's design and user experience.
            </p>
          </div>
        </div>
      </div>
