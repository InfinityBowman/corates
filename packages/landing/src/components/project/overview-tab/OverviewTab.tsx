    ...
    () =>
      studies.filter((s: any) => {
        ...
        const awaitingReconcile = checklists.filter(
          (c: any) =>
            !isReconciledChecklist(c) && c.status === CHECKLIST_STATUS.REVIEWER_COMPLETED,
        );
        ...
        <div className="mb-5 flex flex-col items-center md:flex-row md:items-start md:gap-8">
          <div className="mb-5 md:mb-0">
            <CircularProgress
              ...
              showValue
              variant={
                overallProgress === 100 ? 'success' : overallProgress >= 50 ? 'default' : 'warning'
              }
              size={140}
            />
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span className="inline-flex items-center rounded-md border border-blue-200 bg-blue-50 px-2 py-0.5 text-xs font-medium capitalize text-blue-700">
                      {member.role}
                    </span>
