                          ...
                          <span
                            className={`rounded-full px-2 py-1 text-xs font-medium ${
                              item.type === NAV_ITEM_TYPES.DOMAIN_QUESTION ?
                                displayVal === 'Y' ? 'bg-green-100 text-green-700'
                                : displayVal === 'PY' ? 'bg-lime-100 text-lime-700'
                                : displayVal === 'PN' ? 'bg-amber-100 text-amber-700'
                                : displayVal === 'N' ? 'bg-red-100 text-red-700'
