    ...
    <div className={`rounded-lg border p-6 ${colors.border} ${colors.bg}`}>
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          {level.note && (
            <p className="mt-2 text-sm italic text-gray-500">{level.note}</p>
          )}
        </div>
      </div>
    </div>
          ...
          <div className="space-y-8 leading-relaxed text-gray-700">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
              <p className="text-sm leading-relaxed text-gray-600">
                CoRATES supports the structured use of this appraisal framework
                by providing workflow, documentation, and collaboration features.
                CoRATES does not reproduce, modify, or replace the instrument.
              </p>
              <p className="mt-2 text-sm leading-relaxed text-gray-600">
                This framework is the intellectual property of its original
                authors. Users should consult the official publications and
                guidance linked above when applying the tool.
              </p>
            </div>
