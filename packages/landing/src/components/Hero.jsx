    ...
    <section class='relative overflow-hidden'>
      <div class='max-w-6xl mx-auto px-6 py-16 md:py-24 text-center'>
        ...
        <p class='text-lg text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto'>
          Streamline the entire quality and risk-of-bias appraisal process with intuitive workflows,
          real-time collaboration, automatic scoring, and clear visual summaries, creating greater
        ...
        <p class='mt-6 text-sm text-gray-500'>
          ...
          <a href={urls.checklist()} class='text-blue-600 hover:text-blue-700 font-medium hover:underline'>
            Start an appraisal
          </a>
        </p>
      </div>
