...
export const GOOGLE_PICKER_API_KEY: string = import.meta.env.VITE_GOOGLE_PICKER_API_KEY;
export const GOOGLE_PICKER_APP_ID: string = import.meta.env.VITE_GOOGLE_PICKER_APP_ID;
