...
/**
 * Helper to create reactive signals for form errors
 * Returns reactive signals for field errors and global error
 * Accepts framework-specific signal/store factories as parameters
 * @param {Function} createSignal - Signal factory (e.g., useState wrapper)
 * @param {Function} createStore - Store factory (e.g., useState wrapper for objects)
