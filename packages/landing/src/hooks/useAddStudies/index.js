...
import { usePdfOperations } from './pdfs.js';
import { useReferenceOperations } from './references.js';
import { useLookupOperations } from './lookup.js';
import { useDriveOperations } from './drive.js';
...
export function useAddStudies(options = {}) {
  ...
  }, [getStudiesToSubmit, options.collectMode]); // eslint-disable-line react-hooks/exhaustive-deps
