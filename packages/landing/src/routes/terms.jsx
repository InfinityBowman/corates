          ...
          <div class='max-w-3xl mx-auto px-6'>
            ...
            <div class='text-gray-700 leading-relaxed space-y-6'>
              <p>
                ...
                THIS AGREEMENT BY (A) PURCHASING ACCESS TO THE SERVICE THROUGH AN ONLINE ORDERING
                PROCESS THAT REFERENCES THIS AGREEMENT, (B) SIGNING UP FOR A FREE ACCESS PLAN FOR
                THE SERVICE THROUGH A SCREEN THAT REFERENCES THIS AGREEMENT, OR (C) CLICKING A BOX
              ...
              <p>
                ...
                cloud-based collaborative research appraisal tool for evidence synthesis (the
                "Service"). The Service allows users to create projects, manage studies, complete
                quality assessment checklists (such as AMSTAR 2), collaborate with team members, and
                organize research materials. Anything Customer (including Users) posts, uploads,
                shares, stores, or otherwise provides through the Service is considered a "User
                Submission." Customer is solely responsible for all User Submissions it contributes
                to the Service. The Service may also include templates, help documents, and other
                documents or information that can assist Customer using the Service ("CoRATES
                Content"). Customer will not receive or have access to the code or software that
                underlies the Service (collectively the "Software") or receive a copy of the
                Software itself.
              </p>
              ...
              <p>
                <strong>1.3. CoRATES's Ownership.</strong> CoRATES owns the Service, Software,
                CoRATES Content, Documentation, and anything else provided by CoRATES to Customer
                (collectively the "CoRATES Materials"). CoRATES retains all right, title and
              ...
              <p>
                ...
                CoRATES will have no responsibility for managing Permissions and no liability for
              ...
              <p>
                ...
                that are not owned or controlled by CoRATES (e.g., ORCID, Google Drive)
                ("Third-Party Applications") and Customer, at its sole option, may choose to use
                such Third-Party Applications. CoRATES does not endorse such Third-Party
                ...
                Customer's use. CoRATES expressly disclaims all representations and warranties
              ...
              <p>
                ...
                Agreement, non-refundable. CoRATES may modify its Fees or introduce new fees in its
                sole discretion. Customer always has the right to choose not to renew its
                subscription if it does not agree with any new or revised Fees.
              </p>

              <p>
                <strong>4.2. Payment.</strong> CoRATES, either directly or through its third-party
                payment processor ("Payment Processor") will charge Customer for the Fees via credit
                card or other payment method, pursuant to the payment information provided by
                Customer to CoRATES. It is Customer's sole responsibility to provide CoRATES with
              ...
              <p>
                ...
                CoRATES may suspend Customer's access to the Service pending payment of such overdue
                amounts.
              </p>
              ...
              <p>
                ...
                choose not to renew its Subscription Period by notifying CoRATES or by modifying its
                subscription through Customer's account within the Service. This Agreement will
              ...
              <p>
                ...
                party's receipt of such notice. CoRATES may terminate Customer's access to any free
                version at any time upon notice to Customer.
              </p>

              <p>
                <strong>5.3. Effect of Termination.</strong> If Customer terminates this Agreement
                because of CoRATES's uncured breach, CoRATES will refund any unused, prepaid Fees
                for the remainder of the then-current Subscription Period. Upon any termination of
                this Agreement, all rights and licenses granted by CoRATES hereunder will
                immediately terminate; Customer will no longer have the right to access or use the
                Service. Within thirty (30) days of termination, upon Customer's request, CoRATES
                will delete Customer's User Information and User Submissions.
              </p>

              <p>
                <strong>5.4. Survival.</strong> Sections titled "CoRATES's Ownership", "Third-Party
              ...
              <p>
                ...
                AND "AS AVAILABLE" BASIS WITHOUT ANY WARRANTIES OF ANY KIND, AND CORATES EXPRESSLY
                ...
                NON-INFRINGEMENT. CUSTOMER ACKNOWLEDGES THAT CORATES DOES NOT WARRANT THAT THE
                SERVICES WILL BE UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE. THE SERVICE IS A TOOL
                TO ASSIST WITH RESEARCH QUALITY ASSESSMENT AND DOES NOT REPLACE PROFESSIONAL
                JUDGMENT.
              </p>
              ...
              <p>
                ...
                circumstances of disclosure ("Confidential Information"). CoRATES's Confidential
              ...
              <p>
                ...
                hereby grants to CoRATES a royalty-free, worldwide, perpetual, irrevocable, fully
              ...
              <p>
                ...
                ("User Information") upon logging into the Service. Customer grants CoRATES and its
              ...
              <p>
                ...
                identifying information is revealed, CoRATES is free to use the Service Data in any
                manner.
              </p>

              <p>
                <strong>9.4. Data Protection.</strong> CoRATES has established and implemented
              ...
              <p>
                ...
                subscription-based product, and that to provide improved customer experience CoRATES
                may make changes to the Service, provided however CoRATES will not materially
                decrease the core functionality of the Service. CoRATES may also unilaterally modify
                the terms of this Agreement by notifying Customer at least thirty (30) days prior to
              ...
              <p>
                ...
                by email. Notices to CoRATES must be sent to{' '}
              ...
              <p>
                ...
                party. Notwithstanding the foregoing, CoRATES may assign this Agreement in its
                entirety, without the consent of Customer, in connection with a merger, acquisition,
                corporate reorganization, or sale of all or substantially all of CoRATES's assets.
              </p>
