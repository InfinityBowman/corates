        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-12 rounded-lg bg-gray-50 p-6">
            ...
            <p className="text-gray-600">
              CoRATES supports multiple evidence appraisal tools used in
              systematic reviews and research synthesis. Each tool is designed
              for specific study types and provides structured guidance for
              assessing methodological quality or risk of bias. Select a tool
              above to learn more about its purpose, scoring methodology, and
