...
function PricingPage() {
  ...
  const singleProjectPlan = catalog.plans.find(
    (p) => p.tier === 'single_project',
  )
      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            Start with a free trial, then choose the plan that fits your team's
            needs.
          </p>
        </div>
            ...
            <div className="flex flex-col items-center gap-4 text-center sm:flex-row sm:text-left">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  {trialPlan.features[0]}. {trialPlan.features[1]}. No credit
                  card required.
                </p>
              </div>
              <a
                    ...
                    plan.price[billingInterval] !== null ? (
                      <>
                        ...
                        <div
                          ...
                          style={{
                            gridTemplateRows:
                              billingInterval === 'yearly' ? '1fr' : '0fr',
                          }}
                        >
                          <div className="overflow-hidden">
