      ...
      <main className="flex-1 py-12">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="space-y-6 leading-relaxed text-gray-700">
            <p>
              At Syntch LLC, doing business as CoRATES ("Syntch LLC" or "we"),
              we take your privacy seriously. Please read this Privacy Policy to
              learn how we treat your personal data. By using or accessing our
            ...
            <h2
              id="what-this-covers"
              className="pt-6 text-xl font-semibold text-gray-900"
            >
              What this Privacy Policy Covers
            </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="border-l-2 border-gray-200 pl-4">
                ...
                <p className="text-sm text-gray-600">
                  <strong>Third Parties We Share With:</strong> Service Providers
                  (specifically our payment processing partner)
                </p>
              </div>
              ...
              <div className="border-l-2 border-gray-200 pl-4">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  <strong>Examples:</strong> Technical error reports, browser
                  type and version, stack traces when an error occurs
                </p>
                <p className="text-sm text-gray-600">
                  <strong>Third Parties We Share With:</strong> Service Providers
              ...
              <div className="border-l-2 border-gray-200 pl-4">
                ...
                <p className="text-sm text-gray-600">
                  <strong>Third Parties We Share With:</strong> Collaborators you
              ...
              <div className="border-l-2 border-gray-200 pl-4">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  <strong>Examples:</strong> Identifying information in emails or
                  letters you send us, uploaded PDF documents
                </p>
                <p className="text-sm text-gray-600">
                  <strong>Third Parties We Share With:</strong> Service
                  Providers, Parties You Authorize
            ...
            <ul className="ml-6 list-outside list-disc space-y-2">
              ...
              <li>
                ...
                <ul className="mt-1 ml-6 list-outside list-disc text-gray-600">
                  <li>
                    Vendors (we use Sentry for error monitoring to identify and
                    fix technical issues with the Services)
                  </li>
                  <li>
            ...
            <ul className="ml-6 list-outside list-disc space-y-2">
              ...
              <li>
                ...
                <ul className="mt-1 ml-6 list-outside list-disc text-gray-600">
                  ...
                  <li>
                    Protecting the rights, property or safety of you, Syntch LLC
                    or another party
                  </li>
            ...
            <ul className="ml-6 list-outside list-disc space-y-3">
              <li>
                ...
                <ul className="mt-1 ml-6 list-outside list-disc text-gray-600">
                  ...
                  <li>
                    Email service providers (Postmark / ActiveCampaign, LLC)
                  </li>
            ...
            <p>
              ...
              business. Should one of these events occur, we will make reasonable
            ...
            <p>
              ...
              with third parties for our lawful business purposes, provided that
              we will not share such data in a manner that could identify you.
            </p>
            ...
            <p>
              If you choose to sign in with Google or connect your Google account
              to use Google Drive features, Syntch LLC will process certain
            ...
            <ul className="ml-6 list-outside list-disc space-y-2 text-gray-600">
              ...
              <li>
                <strong>Tokens stored.</strong> When you connect Google, we store
                OAuth tokens (such as access tokens and, when provided by Google,
                refresh tokens) associated with your account so we can maintain
                the connection and retrieve a short-lived access token when
                needed (for example, for the Google Picker experience or when an
                access token expires).
              </li>
              <li>
                <strong>What we do with Drive data.</strong> When you initiate an
                import, we use the Google Drive API to fetch file metadata (for
                example file name, MIME type and size) and download the contents
                of the specific file you selected. We then copy that PDF into
                CoRATES storage (Cloudflare R2) so it can be attached to your
                project/study within the Service. We may store the Google Drive
                file ID and file name as part of import metadata to support the
                import and auditing.
              </li>
              <li>
            ...
            <p>
              Syntch LLC's use of information received from Google APIs will
              comply with the Google API Services User Data Policy, including the
              Limited Use requirements. In particular, we use Google Drive data
              only to provide the user-requested functionality (such as importing
              a selected PDF into your project) and do not use Google Drive data
              for advertising.
            </p>
            ...
            <p>
              We use Stripe, Inc. as our payment processor to handle subscription
              payments and billing. When you subscribe to a paid plan or update
              your payment information:
            </p>

            <ul className="ml-6 list-outside list-disc space-y-2 text-gray-600">
              <li>
                <strong>Data collected by Stripe.</strong> Stripe collects your
                payment card information (card number, expiration date, CVC),
                billing address, and email address directly. This payment
                information is processed and stored by Stripe and is subject to
                Stripe's Privacy Policy (https://stripe.com/privacy).
              </li>
              <li>
                <strong>Data we receive from Stripe.</strong> We receive limited
                information from Stripe, including the last four digits of your
                payment card, card type, billing address, and subscription
                status. We do not receive or store your full payment card number.
              </li>
              <li>
                <strong>Data we send to Stripe.</strong> We send your email
                address and account identifiers to Stripe to associate payments
                with your account and to enable Stripe to send payment-related
                communications (such as receipts and failed payment
                notifications).
              </li>
              <li>
                <strong>International transfers.</strong> Stripe may process your
                payment data in the United States or other countries where Stripe
                operates. Stripe is certified under the EU-U.S. Data Privacy
                Framework. For more information, see Stripe's privacy
                documentation.
              </li>
            </ul>
            ...
            <p>
              We use Postmark (operated by ActiveCampaign, LLC) to send
              transactional emails, including account verification, password
              resets, project invitations, and other Service-related
              notifications.
            </p>

            <ul className="ml-6 list-outside list-disc space-y-2 text-gray-600">
              <li>
                <strong>Data shared with Postmark.</strong> When we send you an
                email, we share your email address and name with Postmark. The
                email content may include information relevant to the
                notification (such as project names or invitation details).
              </li>
              <li>
                <strong>Data Postmark collects.</strong> Postmark may collect
                metadata about email delivery, such as whether an email was
                opened or bounced, to help us ensure reliable email delivery.
              </li>
              <li>
                <strong>Data retention.</strong> Postmark retains email logs and
                metadata in accordance with their data retention policies. For
                more information, see Postmark's Privacy Policy
                (https://postmarkapp.com/privacy-policy).
              </li>
              <li>
                <strong>International transfers.</strong> Postmark may process
                email data in the United States. ActiveCampaign participates in
            ...
            <p>
              The Services use cookies and similar technologies (collectively,
              "Cookies") to enable our servers to recognize your web browser and
              operate and improve our Services. We also use Sentry, a
              third-party error monitoring service, to collect technical error
              reports (such as stack traces and browser metadata) when something
              goes wrong. Sentry does not track your browsing behavior or collect
            ...
            <p>
              ...
              off after you have finished accessing your account. Although we
              work to protect the security of your account and other data that we
              hold in our records, please be aware that no method of transmitting
            ...
            <p>
              ...
              Lichtenstein, Norway or Iceland, you may have additional rights
            ...
            <p>
              ...
              storage and disclosure. Syntch LLC will be the controller of your
            ...
            <ul className="ml-6 list-outside list-disc space-y-2">
              ...
              <li>
                ...
                lodge a complaint about Syntch LLC's practices with respect to
                your Personal Data with the supervisory authority of your country
                or EU Member State.
              </li>
            </ul>
            ...
            <p>
              ...
              through Syntch LLC and its service providers, and if you do not
              ...
              obtained from a third party, is being provided to Syntch LLC in the
              U.S. and will be hosted on U.S. servers, and you authorize Syntch
              LLC to transfer, store and process your information to and in the
              U.S., and possibly other countries.
            </p>

            <p>
              Our service providers, including Cloudflare, Stripe, and Postmark,
              may process your data in the United States or other jurisdictions.
              These providers have committed to appropriate safeguards for
              international data transfers, including certification under the
              EU-U.S. Data Privacy Framework or implementation of Standard
              ...
              to request more information about the safeguards we have in place
            ...
            <p>
              ...
              to any such changes by placing a notice on the CoRATES website, by
            ...
            <p>
              ...
              choices and rights regarding such collection and use, please do not
