        ...
        <div className='mx-auto max-w-3xl px-6'>
          ...
          <div className='flex flex-col gap-6 leading-relaxed text-gray-700'>
            <p>
              ...
              practices and policies outlined below, and you hereby consent that we will collect,
              use and share your information as described in this Privacy Policy.
            </p>
            ...
            <p>
              ...
              . Any terms we use in this Policy without defining them have the definitions given to
            ...
            <div className='my-8 rounded-lg bg-gray-50 p-6'>
              ...
              <ul className='flex flex-col gap-2 text-gray-700'>
                ...
                <li>
                  <a href='#how-we-share' className='hover:text-blue-600'>
                    How We Share Your Personal Data
                  </a>
                </li>
                <li>
                  <a href='#tracking-tools' className='hover:text-blue-600'>
                ...
                <li>
                  <a href='#state-rights' className='hover:text-blue-600'>
                    State Law Privacy Rights
                  </a>
                </li>
                <li>
                  <a href='#eu-rights' className='hover:text-blue-600'>
            ...
            {/* What this Privacy Policy Covers */}
            <h2 id='what-this-covers' className='pt-6 text-xl font-semibold text-gray-900'>
              What this Privacy Policy Covers
            </h2>
            ...
            {/* Personal Data */}
            <h2 id='personal-data' className='pt-6 text-xl font-semibold text-gray-900'>
              Personal Data
            </h2>

            <h3 className='pt-4 text-lg font-medium text-gray-900'>
            ...
            <div className='flex flex-col gap-6'>
              ...
              <div className='border-l-2 border-gray-200 pl-4'>
                ...
                <p className='text-sm text-gray-600'>
                  <strong>Third Parties We Share With:</strong> Service Providers (specifically our
                  payment processing partner)
                </p>
              </div>

              <div className='border-l-2 border-gray-200 pl-4'>
                <h4 className='font-medium text-gray-900'>Device/IP Data</h4>
                <p className='mt-1 text-sm text-gray-600'>
              ...
              <div className='border-l-2 border-gray-200 pl-4'>
                <h4 className='font-medium text-gray-900'>Error and Diagnostic Data</h4>
                <p className='mt-1 text-sm text-gray-600'>
                  <strong>Examples:</strong> Technical error reports, browser type and version,
                  stack traces when an error occurs
                </p>
                <p className='text-sm text-gray-600'>
                  <strong>Third Parties We Share With:</strong> Service Providers (Sentry for error
                  monitoring)
                </p>
              </div>

              <div className='border-l-2 border-gray-200 pl-4'>
                <h4 className='font-medium text-gray-900'>Research Project Data</h4>
                <p className='mt-1 text-sm text-gray-600'>
                  <strong>Examples:</strong> Projects, studies, checklists, assessments, and
                  documents you create within the Service
                </p>
                <p className='text-sm text-gray-600'>
                  <strong>Third Parties We Share With:</strong> Collaborators you invite, Service
                  Providers
                </p>
              </div>
            ...
            <ul className='ml-6 flex list-outside list-disc flex-col gap-2'>
              ...
              <li>
                ...
                <ul className='mt-1 ml-6 list-outside list-disc text-gray-600'>
                  <li>
                    Vendors (we use Sentry for error monitoring to identify and fix technical issues
                    with the Services)
                  </li>
                  <li>
            ...
            {/* How We Share Your Personal Data */}
            <h2 id='how-we-share' className='pt-6 text-xl font-semibold text-gray-900'>
              How We Share Your Personal Data
            </h2>
            ...
            <h3 className='pt-4 text-lg font-medium text-gray-900'>Legal Obligations</h3>
            ...
            <h3 className='pt-4 text-lg font-medium text-gray-900'>Business Transfers</h3>
            ...
            <p>
              ...
              party assumes control of our business. Should one of these events occur, we will make
            ...
            <p>
              ...
              share it with third parties for our lawful business purposes, provided that we will
            ...
            <ul className='ml-6 flex list-outside list-disc flex-col gap-2 text-gray-600'>
              ...
              <li>
                ...
                as access tokens and, when provided by Google, refresh tokens) associated with your
                account so we can maintain the connection and retrieve a short-lived access token
                when needed (for example, for the Google Picker experience or when an access token
                expires).
              </li>
              <li>
                <strong>What we do with Drive data.</strong> When you initiate an import, we use the
                Google Drive API to fetch file metadata (for example file name, MIME type and size)
                and download the contents of the specific file you selected. We then copy that PDF
                into CoRATES storage (Cloudflare R2) so it can be attached to your project/study
                within the Service. We may store the Google Drive file ID and file name as part of
                import metadata to support the import and auditing.
              </li>
              <li>
                ...
                remove those, you must delete them from within the Service (or delete your account,
                where applicable).
              </li>
            </ul>

            <p>
              Syntch LLC's use of information received from Google APIs will comply with the Google
              API Services User Data Policy, including the Limited Use requirements. In particular,
              we use Google Drive data only to provide the user-requested functionality (such as
              importing a selected PDF into your project) and do not use Google Drive data for
              advertising.
            </p>

            <h3 className='pt-4 text-lg font-medium text-gray-900'>Payment Processing (Stripe)</h3>
            ...
            <ul className='ml-6 flex list-outside list-disc flex-col gap-2 text-gray-600'>
              <li>
                ...
                directly. This payment information is processed and stored by Stripe and is subject
                to Stripe's Privacy Policy (https://stripe.com/privacy).
              </li>
              <li>
                ...
                address, and subscription status. We do not receive or store your full payment card
                number.
              </li>
              <li>
              ...
              <li>
                ...
                under the EU-U.S. Data Privacy Framework. For more information, see Stripe's privacy
                documentation.
              </li>
            </ul>
            ...
            <ul className='ml-6 flex list-outside list-disc flex-col gap-2 text-gray-600'>
              <li>
                ...
                relevant to the notification (such as project names or invitation details).
              </li>
              <li>
                <strong>Data Postmark collects.</strong> Postmark may collect metadata about email
                delivery, such as whether an email was opened or bounced, to help us ensure reliable
                email delivery.
              </li>
              <li>
                <strong>Data retention.</strong> Postmark retains email logs and metadata in
                accordance with their data retention policies. For more information, see Postmark's
            ...
            {/* Tracking Tools and Opt-Out */}
            <h2 id='tracking-tools' className='pt-6 text-xl font-semibold text-gray-900'>
              Tracking Tools and Opt-Out
            </h2>

            <p>
              The Services use cookies and similar technologies (collectively, "Cookies") to enable
              our servers to recognize your web browser and operate and improve our Services. We
              also use Sentry, a third-party error monitoring service, to collect technical error
              reports (such as stack traces and browser metadata) when something goes wrong. Sentry
              does not track your browsing behavior or collect personally identifiable information.
            </p>
            ...
            <ul className='ml-6 flex list-outside list-disc flex-col gap-2'>
              <li>
                ...
                enable you to log into secure areas of our Services. Disabling these Cookies may
              ...
              <li>
                ...
                choices and settings regarding our Services, maintain your preferences over time and
            ...
            <p>
              ...
              prevent your browser from accepting new Cookies. If you do this, however, you may have
              to manually adjust some preferences every time you visit our website and some of the
              Services and functionalities may not work.
            </p>

            {/* Data Security and Retention */}
            <h2 id='data-security' className='pt-6 text-xl font-semibold text-gray-900'>
              Data Security and Retention
            </h2>
            ...
            <p>
              ...
              measures based on the type of Personal Data and how we are processing that data. These
              measures include:
            </p>
            ...
            <p>
              You should also help protect your data by appropriately selecting and protecting your
            ...
            {/* Personal Data of Children */}
            <h2 id='children' className='pt-6 text-xl font-semibold text-gray-900'>
              Personal Data of Children
            </h2>
            ...
            <p>
              ...
              age of 13. If you are under 13, please do not attempt to register for the Services or
              send any Personal Information about yourself to us. If we learn that we have collected
            ...
            {/* State Law Privacy Rights */}
            <h2 id='state-rights' className='pt-6 text-xl font-semibold text-gray-900'>
              State Law Privacy Rights
            </h2>

            <h3 className='pt-4 text-lg font-medium text-gray-900'>California Resident Rights</h3>
            ...
            <h3 className='pt-4 text-lg font-medium text-gray-900'>Nevada Resident Rights</h3>
            ...
            {/* European Union Data Subject Rights */}
            <h2 id='eu-rights' className='pt-6 text-xl font-semibold text-gray-900'>
              European Union Data Subject Rights
            </h2>

            <h3 className='pt-4 text-lg font-medium text-gray-900'>EU Residents</h3>

            <p>
              If you are a resident of the European Union ("EU"), United Kingdom, Lichtenstein,
              Norway or Iceland, you may have additional rights under the EU General Data Protection
              Regulation (the "GDPR") with respect to your Personal Data.
            </p>

            <p>
              For this section, we use the terms "Personal Data" and "processing" as they are
              defined in the GDPR, but "Personal Data" generally means information that can be used
              to individually identify a person, and "processing" generally covers actions that can
              be performed in connection with data such as collection, use, storage and disclosure.
              Syntch LLC will be the controller of your Personal Data processed in connection with
              the Services.
            </p>

            <h3 className='pt-4 text-lg font-medium text-gray-900'>EU Data Subject Rights</h3>
            ...
            <ul className='ml-6 flex list-outside list-disc flex-col gap-2'>
              ...
              <li>
                ...
                about you is incorrect or incomplete, you can request that we correct or supplement
                such data.
              </li>
              <li>
              ...
              <li>
                <strong>Withdrawal of Consent:</strong> If we are processing your Personal Data
              ...
              <li>
                ...
                further use or disclosure of your Personal Data for certain purposes, such as for
              ...
              <li>
                ...
                about Syntch LLC's practices with respect to your Personal Data with the supervisory
                authority of your country or EU Member State.
              </li>
            </ul>

            <h3 className='pt-4 text-lg font-medium text-gray-900'>Transfers of Personal Data</h3>

            <p>
              The Services are hosted and operated in the United States ("U.S.") through Syntch LLC
              and its service providers, and if you do not reside in the U.S., laws in the U.S. may
              differ from the laws where you reside. By using the Services, you acknowledge that any
              Personal Data about you, regardless of whether provided by you or obtained from a
              third party, is being provided to Syntch LLC in the U.S. and will be hosted on U.S.
              servers, and you authorize Syntch LLC to transfer, store and process your information
            ...
            {/* Changes to this Privacy Policy */}
            <h2 id='changes' className='pt-6 text-xl font-semibold text-gray-900'>
              Changes to this Privacy Policy
            </h2>

            <p>
              We're constantly trying to improve our Services, so we may need to change this Privacy
              Policy from time to time, but we will alert you to any such changes by placing a
              notice on the CoRATES website, by sending you an email and/or by some other means.
              Please note that if you've opted not to receive legal notice emails from us (or you
              haven't provided us with your email address), those legal notices will still govern
              your use of the Services, and you are still responsible for reading and understanding
              them. If you use the Services after any changes to the Privacy Policy have been
              posted, that means you agree to all of the changes.
            </p>

            {/* Contact Information */}
            <h2 id='contact' className='pt-6 text-xl font-semibold text-gray-900'>
              Contact Information
            </h2>
