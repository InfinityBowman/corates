                ...
                <div className='flex items-start gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600'>
                      ...
                      and can revoke access at any time. You retain full ownership of your research
                      data. CoRATES does not sell or share your data with third parties.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600'>
                    ...
                    reasonable time to investigate and mitigate the vulnerability before making any
                    information public.
                  </p>
                </div>
              </div>
