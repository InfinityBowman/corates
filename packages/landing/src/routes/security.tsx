              ...
              <div className="rounded-lg bg-gray-50 p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      We support multiple secure authentication methods including
                      OAuth (Google, ORCID), passwordless login via email, and
                      two-factor authentication (2FA) for enhanced account
                      security.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      sign-in, registration, password resets, and email flows) to
              ...
              <div className="rounded-lg bg-gray-50 p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      CoRATES is hosted on Cloudflare's global network, providing
                      enterprise-grade security, DDoS protection, and a Web
                      Application Firewall (WAF) to protect against common web
                      vulnerabilities.
                    </p>
                  </div>
                </div>
