          ...
          <div class="space-y-8 leading-relaxed text-gray-700">
            ...
            <div>
              ...
              <p class="mb-6 text-gray-600">
                ...
                is a critical appraisal tool used to assess the methodological
                quality and risk of bias of systematic reviews of interventions,
                including reviews that incorporate randomized and non-randomized
                studies. It evaluates 16 domains and supports judgments about
                confidence in a review's findings (high to critically low),
                helping users determine how much trust to place in review
                results.
              </p>
            </div>
            ...
            <div class="border-t border-gray-200 pt-8">
              ...
              <p class="mb-6 text-gray-600">
                CoRATES automatically generates the overall score using decision
                rules that follow the scoring guidance published in the AMSTAR 2
                paper, ensuring consistency with the tool's intended
                interpretation.
              </p>
                  ...
                  <div class="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p class="text-gray-600">
                        ...
                        results of the available studies that address the
                  ...
                  <div class="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-gray-500 italic">
                        *Multiple non-critical weaknesses may diminish
                        confidence in the review and it may be appropriate to
