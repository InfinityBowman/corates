      ...
      <main class='mx-auto max-w-6xl px-6 py-12'>
        <div class='mx-auto max-w-2xl text-center'>
          ...
          <p class='mt-4 text-lg text-gray-600'>
            CoRATES is currently in active development and testing. We're working closely with early
            users to refine features, workflows, and team-based collaboration. Pricing will be
            announced closer to launch and will reflect the needs of individual researchers, teams,
            and institutions. Interested in getting involved?{' '}
