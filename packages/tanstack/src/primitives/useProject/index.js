...
export function useProject(projectId) {
  ...
  const connectionState = createMemo(() =>
    projectStore.getConnectionState(projectId),
  )
  ...
  function connect() {
    ...
    connectionEntry.checklistOps = createChecklistOperations(
      projectId,
      getYDoc,
      synced,
    )
    ...
    projectActionsStore._setConnection(projectId, {
      ...
      getChecklistAnswersMap:
        connectionEntry.checklistOps.getChecklistAnswersMap,
      ...
      saveReconciliationProgress:
        connectionEntry.reconciliationOps.saveReconciliationProgress,
      getReconciliationProgress:
        connectionEntry.reconciliationOps.getReconciliationProgress,
      getReconciliationNote:
        connectionEntry.reconciliationOps.getReconciliationNote,
      clearReconciliationProgress:
        connectionEntry.reconciliationOps.clearReconciliationProgress,
  ...
  return {
    ...
    updateProjectSettings: (...args) =>
      connectionEntry?.studyOps?.updateProjectSettings(...args),
    renameProject: (...args) =>
      connectionEntry?.studyOps?.renameProject(...args),
    updateDescription: (...args) =>
      connectionEntry?.studyOps?.updateDescription(...args),

    // Checklist operations
    createChecklist: (...args) =>
      connectionEntry?.checklistOps?.createChecklist(...args),
    updateChecklist: (...args) =>
      connectionEntry?.checklistOps?.updateChecklist(...args),
    deleteChecklist: (...args) =>
      connectionEntry?.checklistOps?.deleteChecklist(...args),
    getChecklistAnswersMap: (...args) =>
      connectionEntry?.checklistOps?.getChecklistAnswersMap(...args),
    getChecklistData: (...args) =>
      connectionEntry?.checklistOps?.getChecklistData(...args),
    updateChecklistAnswer: (...args) =>
      connectionEntry?.checklistOps?.updateChecklistAnswer(...args),
    getQuestionNote: (...args) =>
      connectionEntry?.checklistOps?.getQuestionNote(...args),

    // PDF operations
    addPdfToStudy: (...args) => connectionEntry?.pdfOps?.addPdfToStudy(...args),
    removePdfFromStudy: (...args) =>
      connectionEntry?.pdfOps?.removePdfFromStudy(...args),
    removePdfByFileName: (...args) =>
      connectionEntry?.pdfOps?.removePdfByFileName(...args),
    updatePdfTag: (...args) => connectionEntry?.pdfOps?.updatePdfTag(...args),
    updatePdfMetadata: (...args) =>
      connectionEntry?.pdfOps?.updatePdfMetadata(...args),
    setPdfAsPrimary: (...args) =>
      connectionEntry?.pdfOps?.setPdfAsPrimary(...args),
    setPdfAsProtocol: (...args) =>
      connectionEntry?.pdfOps?.setPdfAsProtocol(...args),
