...
export function createStudyOperations(projectId, getYDoc, isSynced) {
  ...
  function createStudy(name, description = '', metadata = {}) {
    ...
    if (metadata.originalTitle)
      studyYMap.set('originalTitle', metadata.originalTitle)
    ...
    if (metadata.importSource)
      studyYMap.set('importSource', metadata.importSource)
  ...
  function updateStudy(studyId, updates) {
    ...
    if (updates.originalTitle !== undefined)
      studyYMap.set('originalTitle', updates.originalTitle)
    ...
    if (updates.abstract !== undefined)
      studyYMap.set('abstract', updates.abstract)
    if (updates.importSource !== undefined)
      studyYMap.set('importSource', updates.importSource)
    if (updates.pdfUrl !== undefined) studyYMap.set('pdfUrl', updates.pdfUrl)
    if (updates.pdfSource !== undefined)
      studyYMap.set('pdfSource', updates.pdfSource)
    ...
    if (updates.reviewer1 !== undefined)
      studyYMap.set('reviewer1', updates.reviewer1)
    if (updates.reviewer2 !== undefined)
      studyYMap.set('reviewer2', updates.reviewer2)
