...
export default function AddStudiesForm(props) {
  ...
  const handleSubmit = async () => {
    ...
    if (studiesToAdd.length === 0) {
      showToast.warning(
        'No Studies',
        'Please add at least one study to import.',
      )
      return
    }
            ...
            <div class="mt-4 border-t border-gray-200 pt-4">
              <div class="flex items-center justify-between">
                <div class="text-sm text-gray-600">
                  ...
                  {studies.totalStudyCount() === 1 ? 'study' : 'studies'} ready
                  to add
                  <span class="ml-2 text-gray-400">
                    ...
                    {[
                      studies.pdfCount() > 0
                        ...
                        : null,
                      studies.refCount() > 0
                        ? `${studies.refCount()} imported`
                        : null,
                      studies.lookupCount() > 0
                        ? `${studies.lookupCount()} from lookup`
                        : null,
                      studies.driveCount() > 0
                        ? `${studies.driveCount()} from Drive`
                        : null,
                    ]
                      .filter(Boolean)
                      .join(', ')}
