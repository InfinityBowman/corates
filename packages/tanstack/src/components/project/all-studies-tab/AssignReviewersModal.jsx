...
export default function AssignReviewersModal(props) {
  ...
  const reviewer1DisabledValues = createMemo(() =>
    reviewer2() ? [reviewer2()] : [],
  )
  const reviewer2DisabledValues = createMemo(() =>
    reviewer1() ? [reviewer1()] : [],
  )
    ...
    >
      <div class="space-y-4">
        <p class="text-sm text-gray-600">
          Assign two reviewers to this study. Each reviewer will independently
        ...
        <div class="space-y-4">
          ...
          <Show
            when={selectsReady()}
            fallback={<div class="grid h-20 grid-cols-2 gap-4" />}
          >
