  ...
  return (
    <div class="space-y-3">
      <p class="text-sm text-gray-500">
        Upload research papers to automatically create studies. Titles will be
              ...
              >
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <Show when={pdf.error}>
                    ...
                    <p class="mt-1 truncate text-xs text-red-600">
                      {pdf.file.name}
                    </p>
                  </Show>
                  ...
                  <Show when={!pdf.error && !pdf.extracting}>
                    <div class="flex items-center gap-2">
                      <input
                        ...
                        value={pdf.title || ''}
                        onInput={(e) =>
                          studies.updatePdfTitle(pdf.id, e.target.value)
                        }
