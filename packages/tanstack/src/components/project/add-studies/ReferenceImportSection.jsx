    ...
    <div class="space-y-3">
        ...
        fallback={
          <div class="space-y-3">
            ...
            <div class="flex items-center gap-2 border-b border-gray-200 pb-2">
              <Checkbox
                checked={
                  studies.selectedRefIds().size ===
                  studies.importedRefs().length
                }
                indeterminate={
      ...
      >
        <p class="text-sm text-gray-500">
          Import references from Zotero, EndNote, Mendeley, or other reference
          managers. You can also drop PDFs alongside your reference file to
        ...
        <div class="text-xs text-gray-500">
          ...
          <ul class="list-inside list-disc space-y-0.5">
            <For each={SUPPORTED_FORMATS}>
              {(format) => (
                <li>
                  <span class="font-medium">{format.extension}</span> -{' '}
                  {format.description}
                </li>
              )}
            </For>
          ...
          <p class="mt-2 text-gray-400">
            Tip: Drop a folder from your reference manager to import references
            and PDFs together.
          </p>
        </div>
