...
export default function ReconcileTab() {
  ...
  const openReconciliation = (studyId, checklist1Id, checklist2Id) => {
    navigate({
      to: `/projects/${projectId}/studies/${studyId}/reconcile/${checklist1Id}/${checklist2Id}`,
    })
  }
        ...
        fallback={
          <div class="py-16 text-center">
            ...
            <p class="mx-auto max-w-md text-gray-500">
              Studies where reviewers have completed their checklists will
              appear here for reconciliation.
            </p>
          </div>
        }
      >
