...
export default function UserTable(props) {
  ...
  const formatAccessStatus = (user) => {
    ...
    if (!subscription)
      return { label: 'Free Plan', color: 'gray', plan: 'free' }
  ...
  return (
    <>
                ...
                <tr class="hover:bg-gray-50">
                  ...
                  <td class="px-6 py-4">
                    <div class="flex items-center gap-1.5">
                            ...
                            <Tooltip content={info?.name || provider}>
                              <div class="flex h-5 w-5 items-center justify-center">
                                <Show
                                  when={info?.icon}
                                  fallback={
                                    <FiMail class="h-4 w-4 text-gray-500" />
                                  }
                                >
                                  <img
                                    src={info?.icon}
                      ...
                      <Show
                        when={!user.providers || user.providers.length === 0}
                      >
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <p class="mt-1 text-xs text-gray-500">
              Select the plan tier. Entitlements and quotas are automatically
          ...
          <div>
            ...
            />
            <p class="mt-1 text-xs text-gray-500">
              Leave empty for permanent access. Subscription will expire at the
      ...
      <Dialog
        ...
        title={
          confirmDialog()?.type === 'delete' ? 'Delete User' : 'Revoke Sessions'
        }
        role="alertdialog"
      >
        <div class="space-y-4">
