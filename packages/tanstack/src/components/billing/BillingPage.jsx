...
import { Link as A } from '@tanstack/solid-router'
...
export default function BillingPage() {
  ...
  const searchParams = createMemo(() => {
    ...
    return { success: params.get('success'), canceled: params.get('canceled') }
  })
        ...
        <div class="space-y-4">
          <div>
            ...
            <p class="mt-1 text-sm text-gray-600">
              Click "Manage Subscription" above to access the billing portal
              where you can cancel, update payment methods, or download
              invoices.
            </p>
          </div>
          <div>
            ...
            <p class="mt-1 text-sm text-gray-600">
              Upgrades take effect immediately. You'll be charged the prorated
              difference for the current billing period.
            </p>
          </div>
          <div>
            <h4 class="text-sm font-medium text-gray-900">
            ...
            <p class="mt-1 text-sm text-gray-600">
              We offer a 14-day money-back guarantee. Contact support for refund
              requests.
            </p>
          </div>
        </div>
