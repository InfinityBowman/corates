...
export function Question9(props) {
  ...
  return (
    <div
      class="relative rounded-lg bg-white p-8 text-sm shadow-md"
    ...
    >
      ...
      <div class="mt-2 mb-1 h-4 font-semibold text-gray-900">
        {question.subtitle}
      </div>
      ...
      />
      <div class="mt-2 h-4 font-semibold text-gray-900">
        {question.subtitle2}
      </div>
      <StandardQuestionInternal
        state={stateB}
  ...
  return (
    ...
    >
      ...
      <StandardQuestionInternal
        ...
        width="w-48"
      />
      <div class="mt-4 h-4 font-semibold text-gray-900">
        {question.subtitle2}
      </div>
      <StandardQuestionInternal
        state={stateB}
...
function StandardQuestion(props) {
  ...
  return (
    <div
      class="relative rounded-lg bg-white p-7 pb-3 shadow-md"
      ref={(el) => (containerRef = el)}
    >
                ...
                <For each={col.options}>
                  {(option, optIdx) => (
                    <label class="flex items-center space-x-2 text-xs">
                      ...
                      />
                      <span class="wrap-break-words text-gray-700">
                        {option}
                      </span>
                    </label>
                  )}
      ...
      <div class="container mx-auto max-w-5xl px-4 py-6">
        <Show when={currentChecklist()} fallback={<div>Loading...</div>}>
          ...
          <fieldset
            ...
            class={props.readOnly ? 'opacity-90' : ''}
          >
            <div class="space-y-6">
              <Question1
