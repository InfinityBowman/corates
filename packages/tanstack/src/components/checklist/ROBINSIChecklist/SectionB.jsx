...
export function SectionB(props) {
  ...
  const stopAssessment = createMemo(() =>
    shouldStopAssessment(props.sectionBState),
  )
    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
      <div class="border-b border-gray-200 bg-gray-50 px-6 py-4">
        ...
        <p class="mt-1 text-xs text-gray-500">
          If B2 or B3 is Yes/Probably Yes, the result is classified as Critical
          risk of bias.
        </p>
      </div>
        ...
        <Show when={stopAssessment()}>
          <div class="mt-5 rounded-lg border-2 border-red-200 bg-red-50 p-4">
            ...
            <p class="mt-2 text-sm text-red-700">
              Based on the responses to B2 or B3, this result should be
              classified as
              <span class="font-semibold"> Critical risk of bias</span>. Further
