      ...
      <div class="px-6 py-5">
        ...
        <div class="mb-4 rounded-lg bg-gray-50 p-3">
          ...
          <p class="mt-1 text-xs text-gray-400">
            Based on the highest risk of bias across all domains. You may
            override this judgement below.
          </p>
        </div>
              ...
              {(judgement) => {
                ...
                return (
                  <button
                    ...
                    class={`inline-flex items-center justify-center rounded-lg border-2 px-4 py-2 text-sm font-medium transition-colors ${props.disabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'} ${
                      isSelected()
