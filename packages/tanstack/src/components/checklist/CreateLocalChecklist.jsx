...
export default function CreateLocalChecklist() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate({ to: `/checklist/${checklist.id}` })
    } catch (err) {
      ...
      <div class="w-full max-w-lg">
        <div class="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <p class="mb-6 text-gray-600">
            Start a new quality assessment. Your progress will be saved locally
            on this device.
          </p>
          ...
          <div class="mt-6 rounded-lg bg-gray-50 p-4">
            <p class="text-xs text-gray-500">
              Local studies are stored only on this device and don't require an
              account. To collaborate with others or access your studies from
              multiple devices,{' '}
