        ...
        >
          ...
          <div class="flex-1 overflow-y-auto p-6">
                ...
                <Index each={props.labels}>
                  {(item, index) => (
                    <input
                      ...
                      value={item().label}
                      onInput={(e) =>
                        props.onLabelChange(index, e.target.value)
                      }
              ...
              <div class="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onInput={(e) =>
                      props.onDistributionTitleChange(e.target.value)
                    }
                    class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-sm text-gray-700 transition-colors focus:border-blue-400 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                  />
                </div>
            ...
            <div class="mt-6 border-t border-gray-200 pt-6">
              ...
              <label class="mb-3 flex cursor-pointer items-center gap-3 rounded-lg bg-gray-50 p-3 transition-colors hover:bg-gray-100">
                <input
                  ...
                  onChange={(e) =>
                    props.onTransparentExportChange(e.target.checked)
                  }
                  class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500"
                />
                <div>
                  ...
                  <p class="text-xs text-gray-500">
                    Export without white background
                  </p>
                </div>
              </label>
            ...
            <div class="mt-6 border-t border-gray-200 pt-6">
              ...
              <p class="mb-4 text-xs text-gray-500">
                Use this citation when you reference CoRATES as the software
                used for study appraisal.
              </p>
              ...
              <div class="space-y-4">
                <div class="rounded-lg bg-gray-50 p-4">
                  ...
                  <p class="text-sm leading-relaxed text-gray-700">
                    Maynard, J. A., & Maynard, B. R. (2025). CoRATES
                    (Collaborative Risk-of-Bias and Appraisal Tracking for
                    Evidence Synthesis) [Software]. https://corates.org
                  </p>
                </div>
                ...
                <div class="rounded-lg bg-gray-50 p-4">
                  ...
                  <p class="text-sm leading-relaxed text-gray-700">
                    Maynard JA, Maynard BR. CoRATES (Collaborative Risk-of-Bias
                    and Appraisal Tracking for Evidence Synthesis)[software].
                    2025. Accessed Month Day, Year. https://corates.org
                  </p>
                </div>
              </div>
            </div>
