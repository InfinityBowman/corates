...
export default function CheckEmail() {
  ...
  const { user, isAuthenticated, resendVerificationEmail, session } =
    useBetterAuth()
  ...
  return (
    <div class="flex h-full items-center justify-center bg-blue-50 px-4 py-6 sm:py-12">
      <div class="w-full max-w-md space-y-6 rounded-xl border border-gray-100 bg-white p-6 text-center shadow-2xl sm:max-w-xl sm:rounded-3xl sm:p-12">
        {loading() ? (
          <>
          ...
          <>
            ...
            <div>
              ...
              <p class="mt-1 text-sm font-semibold text-blue-600 sm:text-base">
                {email()}
              </p>
            </div>
            ...
            <div class="space-y-4">
              <p class="text-xs text-gray-500 sm:text-sm">
                ...
                account. Once verified, you'll automatically be redirected to
                the dashboard.
              </p>
            ...
            <div class="space-y-3">
              ...
              <SecondaryButton onClick={handleBackToSignIn}>
                Back to Sign In
              </SecondaryButton>
            </div>
