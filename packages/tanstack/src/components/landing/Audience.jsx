    ...
    <section class="mx-auto max-w-6xl px-6 py-16">
      <div class="rounded-2xl border border-gray-200 bg-white p-8 md:p-12">
        <div class="mb-10 text-center">
          <h2 class="mb-3 text-xl font-bold text-gray-900 md:text-2xl">
            Also great for
          </h2>
          <p class="mx-auto max-w-2xl text-gray-600">
            While CoRATES is designed for research teams appraising studies for
            evidence reviews, its guided checklists and automatic scoring also
