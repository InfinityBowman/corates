    ...
    <section class="relative overflow-hidden">
      <div class="mx-auto max-w-4xl px-6 py-20 text-center md:py-28">
        ...
        <p class="mx-auto max-w-3xl text-lg leading-relaxed text-gray-600 md:text-xl">
          Developed by a research synthesis expert and a software engineer and
          data scientist, CoRATES combines methodological expertise with modern
          software engineering to support rigorous evidence appraisal.
        </p>
