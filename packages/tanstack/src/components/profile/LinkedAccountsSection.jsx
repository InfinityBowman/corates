...
import {
  parseOAuthError,
  getLinkErrorMessage,
} from '@lib/account-linking-errors.js'
  ...
  async function handleLinkProvider(providerId) {
    ...
    try {
      ...
      if (providerId === 'credential') {
        ...
        showToast.info(
          'Add Password',
          'Use the Security section below to set up a password.',
        )
      ...
      const message =
        getLinkErrorMessage(err.code) || err.message || 'Failed to link account'
    ...
    <div class="mb-6 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
      ...
      <div class="border-b border-gray-200 bg-gray-50 px-6 py-4">
        ...
        <p class="mt-1 text-sm text-gray-500">
          Manage how you sign in to CoRATES
        </p>
      </div>
      ...
      <div class="space-y-4 p-6">
        ...
        <Show
          when={!accounts.loading && !accounts.error && accounts()?.length > 0}
        >
        ...
        <Show when={availableProviders().length > 0}>
          <div
            class={
              accounts()?.length > 0 ? 'mt-4 border-t border-gray-200 pt-4' : ''
            }
          >
        ...
        <div class="mt-4 rounded-lg border border-blue-200 bg-blue-50 p-4">
          <div class="flex items-start gap-3">
            ...
            <p class="text-sm text-blue-800">
              <strong>Why link accounts?</strong> Linking multiple sign-in
              methods gives you backup options if you lose access to one. Your
              projects and data are shared across all linked accounts.
            </p>
          </div>
        </div>
      ...
      >
        <div class="space-y-4">
          <p class="text-gray-600">
            ...
            <strong>{unlinkProviderName()}</strong> anymore. Your CoRATES data
            will not be affected.
          </p>

          <p class="text-sm text-gray-500">
            <strong>Note:</strong> If you sign in with {unlinkProviderName()}{' '}
            later without linking first, a new separate account will be created.
          </p>
