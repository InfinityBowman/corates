        ...
        <Show when={needsPassword()}>
          <div class="mb-4 flex items-start space-x-3 rounded-lg border border-amber-200 bg-amber-50 p-3">
            ...
            <div class="text-sm text-amber-800">
              ...
              <p class="mt-1">
                Two-factor authentication requires a password. Use the "Add
        ...
        <div class="flex items-center justify-between">
          <div>
            <div class="flex items-center space-x-2">
              <FiShield
                class={`h-5 w-5 ${isEnabled() ? 'text-green-600' : 'text-gray-400'}`}
              />
          ...
          <Show when={needsPassword()}>
            <div class="flex items-start space-x-3 rounded-lg border border-amber-200 bg-amber-50 p-3">
              ...
              <div class="text-sm text-amber-800">
                <p class="font-medium">Password required</p>
                <p class="mt-1">
                  Disabling two-factor authentication requires a password. Use
                  the "Add Password" option above to set one up first.
                </p>
              </div>
            </div>
          </Show>
