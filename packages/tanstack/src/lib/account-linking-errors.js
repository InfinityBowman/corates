...
export const LINK_ERROR_MESSAGES = {
  ...
  EMAIL_NOT_VERIFIED:
    'Please verify your email with this provider before linking.',
  EMAIL_DOESNT_MATCH:
  ...
  CANNOT_UNLINK_ONLY_ACCOUNT:
    'Cannot unlink your only sign-in method. Link another account first.',
  ...
  UNABLE_TO_LINK_ACCOUNT:
    'Unable to link this account. Please try again or contact support.',
