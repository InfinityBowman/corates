...
function cleanTitle(title) {
  return (
    title
      ...
      .replace(
        /^(original\s+article|research\s+article|review|article)\s*[:|-]?\s*/i,
        '',
      )
      .trim()
  )
...
describe('cleanTitle', () => {
  ...
  describe('prefix removal', () => {
    it('should remove "Original Article:" prefix', () => {
      expect(cleanTitle('Original Article: Study on Effects')).toBe(
        'Study on Effects',
      )
    })

    it('should remove "Research Article -" prefix', () => {
      expect(cleanTitle('Research Article - Study on Effects')).toBe(
        'Study on Effects',
      )
    })

    it('should remove "Review" prefix', () => {
      expect(cleanTitle('Review: Systematic Analysis')).toBe(
        'Systematic Analysis',
      )
    })
