...
export const MIGRATION_SQL = `CREATE TABLE \`account\` (
...
--> statement-breakpoint
ALTER TABLE \`subscription\` ADD \`billingInterval\` text;--> statement-breakpoint
ALTER TABLE \`subscription\` ADD \`stripeScheduleId\` text;`;
