...
export const RESPONSE_TYPES = {
  TWO_OPTION: amstar2.TWO_OPTION_QUESTIONS,
  THREE_OPTION: amstar2.THREE_OPTION_QUESTIONS,
  THREE_OPTION_NO_MA: amstar2.THREE_OPTION_NO_MA_QUESTIONS,
  FOUR_OPTION: amstar2.FOUR_OPTION_QUESTIONS,
};
