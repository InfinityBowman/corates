    ...
    <div class='bg-gray-800 rounded-lg p-6'>
      ...
      <div class='mt-4 p-3 bg-blue-900 border border-blue-700 rounded'>
        ...
        <p class='text-sm text-blue-200'>
          Sessions are stored in Durable Objects with automatic cleanup. Each session has a unique
          ID and can store custom data. Sessions automatically expire after 24 hours of inactivity.
        </p>
      </div>
    </div>
  );
