...
/**
 * Page for reconciling domain-level judgement and direction
 * Shows two rows: Judgement comparison and Direction comparison
 *
 * @param {Object} props
 ...
 * @returns {JSX.Element}
 */
export default function DomainJudgementPage(props) {
