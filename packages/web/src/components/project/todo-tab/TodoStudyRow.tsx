...
export function TodoStudyRow({
  ...
  const addBlockedReason =
    ...
    : outcomes.length === 0 ? 'Add an outcome before starting a RoB 2 or ROBINS-I checklist.'
    : 'You already have a checklist for every outcome in this project.';
  ...
  const addCancelButton =
    ...
    : hasChecklists ?
      <Button
        ...
        title='Add another checklist to this study'
      >
        <PlusIcon className='size-4' />
        Add
      </Button>
