...
export interface ArrowDownProps extends Omit<AnimatedIconProps, 'animation'> {
...
/**
 * Animated arrow-down icon (matches animate-ui)
 * - default: moves down 25% on hover
 * - pointing: morphs to more pointed arrow
 */
export const ArrowDown: Component<ArrowDownProps> = props => {
  ...
  const playAnimation = () => {
    ...
    if (variant === 'default' && groupRef) {
      ...
      if (path1Ref) {
        const anim = animate(path1Ref, { d: 'M12 5v10' } as Record<string, unknown>, {
          duration: 0.3,
          ease: 'easeInOut',
        }) as AnimationControl;
        activeAnimations.push(anim);
      ...
      if (path2Ref) {
        const anim = animate(path2Ref, { d: 'm19 8.5-7 7-7-7' } as Record<string, unknown>, {
          duration: 0.3,
          ease: 'easeInOut',
        }) as AnimationControl;
        activeAnimations.push(anim);
  ...
  const resetAnimation = () => {
    ...
    if (variant === 'default' && groupRef) {
      ...
      if (path1Ref) {
        const anim = animate(path1Ref, { d: 'M12 5v14' } as Record<string, unknown>, {
          duration: 0.3,
          ease: 'easeInOut',
        }) as AnimationControl;
        activeAnimations.push(anim);
      ...
      if (path2Ref) {
        const anim = animate(path2Ref, { d: 'm19 12-7 7-7-7' } as Record<string, unknown>, {
          duration: 0.3,
          ease: 'easeInOut',
        }) as AnimationControl;
        activeAnimations.push(anim);
  ...
  return (
    ...
    >
      <g ref={groupRef}>
        <path ref={path1Ref} d='M12 5v14' />
        <path ref={path2Ref} d='m19 12-7 7-7-7' />
      </g>
    </svg>
  );
};
