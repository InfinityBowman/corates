...
export default function ChecklistTreeItem(props) {
  ...
  return (
    <button
      ...
      class={`flex w-full items-center gap-1.5 rounded px-2 py-1 text-left transition-colors ${isSelected() ? 'bg-blue-100 text-blue-700' : 'text-muted-foreground hover:bg-muted'} `}
    >
