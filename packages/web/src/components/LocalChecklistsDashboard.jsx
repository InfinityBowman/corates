    ...
    <div class='space-y-6'>
      ...
      <Show when={showCreateForm()}>
        <div class='bg-white p-6 rounded-lg border border-gray-200 shadow-sm'>
          <h3 class='text-lg font-semibold text-gray-900 mb-4'>Create New Checklist</h3>

          <div class='space-y-4'>
            <div>
              <label class='block text-sm font-semibold text-gray-700 mb-2'>Checklist Name</label>
              <input
                type='text'
