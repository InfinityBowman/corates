...
describe('compareQuestion', () => {
  it('should identify agreement when final answers match', () => {
    const q1 = { answers: [[true, true], [true, false]], critical: false };
    const q2 = { answers: [[true, true], [true, false]], critical: false };
  ...
  it('should identify disagreement when final answers differ', () => {
    const q1 = { answers: [[true, true], [true, false]], critical: false };
    const q2 = { answers: [[false, false], [false, true]], critical: false };
  ...
  it('should identify disagreement when critical status differs', () => {
    const q1 = { answers: [[true, true], [true, false]], critical: true };
    const q2 = { answers: [[true, true], [true, false]], critical: false };
...
describe('getReconciliationSummary', () => {
  it('should provide counts of agreements and disagreements', () => {
    const comparison = {
      ...
      disagreements: [
        { key: 'q2', reviewer1: { critical: true }, reviewer2: { critical: false } },
      ],
