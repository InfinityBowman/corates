...
export const AMSTAR_CHECKLIST: Record<string, AMSTAR2QuestionSchema> = {
  ...
  q6: {
    info: 'A Yes rating requires that data extraction was performed by at least two independent reviewers, with a consensus process for resolving disagreements. If one reviewer extracted all data, a second reviewer must have checked a sample and demonstrated strong agreement (e.g., kappa >= 0.80).',
...
/**
 * All AMSTAR2 question keys in order
 */
export const AMSTAR2_QUESTION_KEYS = Object.keys(AMSTAR_CHECKLIST);

/**
 * Question keys as stored in checklist data (with a/b variants)
 */
export const AMSTAR2_DATA_KEYS = [
  'q1',
  'q2',
  'q3',
  'q4',
...
/**
 * Critical questions per AMSTAR2 methodology
 */
export const AMSTAR2_CRITICAL_QUESTIONS = [
  'q2',
  'q4',
  'q7',
  'q9a',
