...
const IGNORED_FILES: readonly string[] = [
  'package-lock.json',
  'pnpm-lock.yaml',
  'yarn.lock',
  'bun.lockb',
...
export function registerCodeReviewTools(server: McpServerType, repoRoot: string): void {
  server.tool(
    'code_review',
    ...
    async ({
      ...
      try {
        ...
        const errMsg = execError.message || execError.stderr || '';
