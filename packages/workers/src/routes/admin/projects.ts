/**
 * Stripped — GET/DELETE /api/admin/projects/* migrated to TanStack Start.
 * See packages/web/src/routes/api/admin/projects/.
 *
...
const projectRoutes = $(base.use('*', requireAdmin));
