/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6e0f4421200915145614a4f75305a057)
// Runtime types generated with workerd@1.20251217.0 2025-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserSession" | "ProjectDoc" | "EmailQueue";
	}
	interface Env {
		ENVIRONMENT: "development" | "production";
		DEV_MODE: true;
		AUTH_BASE_URL: "http://localhost:8787" | "https://corates.org";
		AUTH_SECRET: string;
		EMAIL_FROM: string;
		...
		PROJECT_DOC: DurableObjectNamespace<import("./src/index").ProjectDoc>;
		EMAIL_QUEUE: DurableObjectNamespace<import("./src/index").EmailQueue>;
		PDF_BUCKET: R2Bucket;
		DB: D1Database;
	}
}
